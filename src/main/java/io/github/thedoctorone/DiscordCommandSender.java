...
//Dummy Player, Discord's Command Sender
public class DiscordCommandSender implements Player {

    DiscordCommunication dc;
    Main main;
    DiscordCommandSender (DiscordCommunication dc, Main main) {
        this.main = main;
        this.dc = dc;
    }
    ...
    public boolean performCommand(String command) {
        main.getLogger().info("COMMAND EXECUTION! : " + command);
        return true;
    }
...
//    }
    ...
    //This a dummy player for Discord, simply it is just an another console.
    @Override
